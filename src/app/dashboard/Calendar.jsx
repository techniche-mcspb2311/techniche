...
export default function BasicTabs() {
  ...
  return (
    <div>
      <h1 style={{ textAlign: 'center', fontSize: '30px', borderTopRightRadius: "20px", borderTopLeftRadius: '20px', backgroundColor: '#21282D', color: 'white', marginTop: '5vh', }}>Calendar:</h1>
      <Box className="calendarBox" sx={{ width: '100%', height: '30vh', borderRadius: "20px", backgroundColor: '#C2BBAB', boxShadow: '2px 3px 10px 0 #000000'}}>
